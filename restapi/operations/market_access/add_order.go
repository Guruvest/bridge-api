...
type AddOrderHandlerFunc func(AddOrderParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn AddOrderHandlerFunc) Handle(params AddOrderParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// AddOrderHandler interface for that can handle valid add order params
type AddOrderHandler interface {
	Handle(AddOrderParams, interface{}) middleware.Responder
}
...
/*AddOrder swagger:route POST /market/orders Market Access addOrder
